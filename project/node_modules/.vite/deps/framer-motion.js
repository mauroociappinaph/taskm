...
function useCycle(...items) {
  const index2 = (0, import_react41.useRef)(0);
  const [item, setItem] = (0, import_react41.useState)(items[index2.current]);
  const runCycle = (0, import_react41.useCallback)(
    (next2) => {
      index2.current = typeof next2 !== "number" ? wrap(0, items.length, index2.current + 1) : next2;
